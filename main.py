...
# my_cse_id = "037c2615c9b2e4e0f" # working 2
# my_cse_id = "c0a3beee2c76144d0" #main workinggggggggggggggggggggggg
# # my_api_key = "AIzaSyCHee8_tp0jA6i4Ui7IrLR6SE_6RxqD0Wo"
my_cse_id = "6158cb9ed9567478b" #working 333
# my_cse_id = "AIzaSyAvGWHu0SBmEpf2P2fFzdSAE3NowNDjiso"
...
def google_search_result(sus,type,apikey):
    print("google_search_result fn is working...")
    my_api_key = apikey
    if type == 1:
...
def level1_check(sus, og):
    print("level1_check fn is working...")
...
def preprocess(input_file):
    print("Preprocess fn is running...")
...
def taking_input(user_file, db_file):
    print("taking_input fn is running...")
...
def printing_similarity(og, sus, type):
    print("printing_similarity fn is running...")
    if type == 1:
        # join values of sus dictionary to str
        sus = sus['data']
        # sus = ' '.join(sus.values())
